...
const Point=createjs.Point;Point.distance=function(p0,p1){return Math.sqrt(Math.pow(p0.x-p1.x,2)+Math.pow(p0.y-p1.y,2));}
const MathUtil={};MathUtil.lerp=function(v0,v1,t,clamp){if(clamp)t=Math.max(0,Math.min(1,t));var v=v0+(v1-v0)*t;return v;}
MathUtil.lerp2d=function(p0,p1,t,clamp){return new Point(MathUtil.lerp(p0.x,p1.x,t,clamp),MathUtil.lerp(p0.y,p1.y,t,clamp))}
